              ...
              items: [
                ..._categories.map((category) {
                  return DropdownMenuItem<String>(
                    ...
                    child: Row(
                      children: [
                        Icon(_categoryIcons[_categories.indexOf(
                            category)]), // Get icon based on index
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Colors.indigo, // Changed primary to backgroundColor
                  ),
                        ...
                        ElevatedButton(
                          onPressed: () {
                            if (customCategoryName != null &&
                              ...
                              setState(() {
                                _categories.insert(
                                    _categories.length - 1, customCategoryName!);
                                _categoryIcons.insert(
                                    _categoryIcons.length - 1, selectedIcon!);
                                _category = customCategoryName;
                              });
                            }
                            Navigator.of(context).pop(); // Close the custom category dialog
                            Navigator.of(context).pop(); // Close the add expense dialog
                            _showAddExpenseDialog(context); // Reopen the add expense dialog with the new category
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.indigo, // Changed primary to backgroundColor
                          ),
