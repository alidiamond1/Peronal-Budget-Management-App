  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: GoogleFonts.pacifico(
            textStyle: const TextStyle(color: Colors.indigo, fontSize: 24),
          ),
        ),
        actions: [
          Padding(
      ...
      bottomNavigationBar: MyBottomNavigationBar(
        currentIndex: 1, // Set the correct index for this page
        onTap: (index) {
    ...
    return SizedBox(
      ...
      child: ListView(
        ...
        children: [
          ElevatedButton.icon(
            onPressed: () {
              // Show the AddExpenseDialog when the button is pressed
          ...
          children: [
            Row(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () {},
                  child: const Text('See All', style: TextStyle(color: Colors.indigo)),
                ),
              ],
            ),
            const SizedBox(height: 16),
            ListTile(
              ...
              trailing: const Text('-\$89.50', style: TextStyle(color: Colors.red)),
            ),
            ListTile(
              leading: CircleAvatar(
              ...
              trailing:
                  const Text('+\$3,240.50', style: TextStyle(color: Colors.green)),
            ),
            ListTile(
              leading: CircleAvatar(
              ...
              trailing: const Text('-\$14.99', style: TextStyle(color: Colors.red)),
            ),
          ],
        ),
      ),
